...
class DataGenerator:
    ...
    API:
        generate_samples(n_locations, n_orders, min_items_per_order, max_items_per_order,
    ...
    def generate_samples(
        ...
        # Pre-generate skus and locations
        locations = [f"L{i}" for i in range(n_locations)]
        skus = [f"sku{i}" for i in range(n_locations)]
        ...
        for sidx in range(n_samples):
            ...
            # Build ItemLocations
            il = ItemLocations.from_records([{"item_id": sku, "location_id": loc} for sku, loc in zip(skus, locations)])
